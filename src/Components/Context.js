...
const Context = () => {
  ...
  return (
    ...
    <div className='grid grid-cols-1 sm:grid-cols-2 gap-x-6 lg:gap-x-12 gap-y-10 sm:gap-y-20 bg-[#282828] px-5 lg:px-20 py-10'>
        ...
        <div className='my-auto'>
            <h1 className='text-lg sm:text-3xl text-[#d8ac47eb] playwrite text-center'>A Bespoke Experience, Curated for You</h1>
            <hr className='border-t-4 border-[#d8ac47eb] mt-5 mx-auto w-2/12'/>
            <p className="text-white mt-8 text-sm sm:text-lg sm:text-center">At Ashtavinayak Halls, we are driven by our meticulous commitment to quality and consistency. Every aspect of your event is carefully designed and executed to ensure nothing short of the exceptional, every time you choose us. Every team strives to bring to you the best of their ability. Whether it’s an extraordinary menu, unrivalled hospitality, or the simple charm of an event well done, you can be sure that you are with the best.</p>
        </div>
        <div className='my-auto'>
            <h1 className='text-lg sm:text-3xl text-[#d8ac47eb] playwrite text-center'>Luxury and Award-Winning Catering</h1>
            <hr className='border-t-4 border-[#d8ac47eb] mt-5 mx-auto w-2/12'/>
            <p className="text-white mt-8 text-sm sm:text-lg sm:text-center">The venue is exclusively catered to by the award-winning luxury catering company, Blue Sea Catering along with Chetak Caterers and the exclusive vegetarian catering service, Pavitra Catering.

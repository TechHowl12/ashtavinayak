...
const Context = () => {
  ...
  return (
    ...
    <div className='bg-[#282828] py-20'>
         <div data-scroll data-scroll-speed=".2" className='flex flex-col mx-auto w-1/2'>
            ...
            <button className='bg-[#d8ac47eb] btn text-black uppercase px-6 py-2 mt-4 w-2/4 mx-auto'>Download brochure</button>
         </div>
    </div>
